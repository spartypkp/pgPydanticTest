...
def main():
    ...
    # Regular insertion,3
    insert_stupid_person = sql("""INSERT INTO stupid_test_table (name, age, email) VALUES ('me', '24', 'broke@pleasehireme.com');""")
    # Dynamic insertion
    insert_normal_person = sql("INSERT INTO stupid_test_table (name, age, email) VALUES (:name, :age, :email);")
